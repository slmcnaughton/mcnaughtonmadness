                    ...
                    Scrape.create(
                      ...
                      function (err, createdJob) {
                        if (err) console.log(err);
                          ...
                          createdTournament.emailPickReminderJobs.push(
                            createdJob,
                          );
                        }
                      },
                          ...
                          asyncNpm.eachSeries(
                            ...
                            function (team, next) {
                              if (i % 2 === 1) {
                                ...
                                createdRound.matches[location].bottomTeam =
                                  team;
                              ...
                              asyncNpm.series(
                                [
                                  function (callback) {
                                    ...
                                    for (var j = 0; j < 2; j++) {
                                      ...
                                      if (i === 0) {
                                        //Round 2
                                        endTime = new moment(startTime).add(
                                          15,
                                          "h",
                                        );
                                      } else if (i < 3) {
                                      ...
                                      //championship match
                                        ...
                                        endTime = new moment(startTime).add(
                                          5,
                                          "h",
                                        ); //Ends 1 + 3  = 4 hours after roundStart
                                        j++;
                                      }
                                      ...
                                      Scrape.create(
                                        ...
                                        function (err, createdJob) {
                                          if (err) console.log(err);
                                          createdTournament.scrapes.push(
                                            createdJob,
                                          );
                                        },
                                      );
                                ...
                                function (err) {
                                  if (err) console.log(err);
                                    ...
                                    createdTournament.rounds.addToSet(
                                      createdRound,
                                    );
                                    next();
                                  }
                    ...
                    asyncNpm.forEachSeries(
                      ...
                      function (round, next) {
                        if (round.numRound !== 1) {
                          ...
                          //we're looking at the is the first round...no need to add blank matches
                          next();
                        }
                      },
                      function (err) {
